...
export default function AlumnoSalonesPage() {
  ...
  async function loadData() {
    try {
      ...
      console.error("Error cargando salones del alumno:", err);
      ...
      <div className="space-y-6">
        <section className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
          ...
          <p className="mt-2 text-slate-600">
            Consulta los salones virtuales donde estás inscrito.
          </p>
        </section>
        ...
        <section className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
          ...
          <div className="mt-4 space-y-4">
            {loading ? (
              ...
              <p className="text-sm text-slate-500">
                No tienes salones virtuales inscritos.
              </p>
            ) : (
                ...
                >
                  <div className="flex flex-col gap-3">
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        Profesor: {item.main_teacher_name || "Sin asignar"}
                      </p>
                      <p className="text-sm text-slate-500">
